import pytest
from pages.select_multiple_page import Places, Transport, Date

def test_loading_page(select_multiple_page):
    select_multiple_page.open()
    select_multiple_page.test_loading_page()


def test_form_should_not_submit_when_no_option_selected(select_multiple_page):
    select_multiple_page.open()
...
def test_form_should_not_submit_if_any_select_not_selected(select_multiple_page, selected_select_1, option1, selected_select_2, option2, unselected_select):
    select_multiple_page.open()
...
def test_all_options_for_first_select(select_multiple_page, select_option):
    select_multiple_page.open()
...
def test_all_options_for_second_select(select_multiple_page, select_option):
    select_multiple_page.open()
...
@pytest.mark.parametrize("select_option", [x.value for x in Transport])
def test_all_options_for_third_select(select_multiple_page, select_option):
    select_multiple_page.open()
